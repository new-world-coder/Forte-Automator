...
function NotificationToast({ notification, onClose }: NotificationToastProps) {
  ...
  return (
    <div className={`relative rounded-lg border p-4 shadow-lg transition-all duration-300 ${styles.container}`}>
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-shrink-0">
          <button
            onClick={onClose}
            className={`inline-flex rounded-md ${styles.title} hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2`}
          >
